...
vim.api.nvim_set_keymap('n', '<Leader>S', ':so ~/.config/nvim/init.lua <cr>',
                        {noremap = true, silent = true})
...
local mappings = {
    ...
    b = {
        ...
        a = {":BufferCloseAllButCurrent<cr>", "Close all but current"}
    },

    t = {name = "Terminal", g = {"<cmd>lua Fterm_gitui()<cr>", "lazygit"}},
